...
//     version 1.7.0
//     from Assets/Game/Input/XRI Default Input Actions Complete.inputactions
//
...
public partial class @XRIDefaultInputActionsComplete: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @XRIDefaultInputActionsComplete()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""XRI Default Input Actions Complete"",
    ""maps"": [
        {
            ""name"": ""XRI Head"",
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRIHeadActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRILeftHandActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRILeftHandInteractionActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRILeftHandLocomotionActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRIRightHandActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRIRightHandInteractionActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRIRightHandLocomotionActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIDefaultInputActionsComplete m_Wrapper;
        public XRIUIActions(@XRIDefaultInputActionsComplete wrapper) { m_Wrapper = wrapper; }
